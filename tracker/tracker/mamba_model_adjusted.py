...
class MambaPositionPredictor(nn.Module):
    def __init__(self, args, in_dim=36, d_model=96, d_state=8, d_conv=4, expand=2,
        ...
        self.spatial_embedding = SpatialPosEncoding(d_model=32, num_freqs=args.num_freqs)
    ...
    def forward(self, x, lengths, target_len, nll=False):
            ...
            for i, block in enumerate(self.mamba_blocks2):
                """if len(self.mamba_blocks)>1 and i == 0:
