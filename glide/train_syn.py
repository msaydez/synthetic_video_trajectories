...
def main(args):
    ...
    if args.option==5:
       ...
       train_ds = TrajDataset("train_set_gen_new.pkl", option=opt, args=args, augment=False)
       val_ds = TrajDataset("train_set_gen.pkl", option=opt, args=args, augment=False)
    ...
    if args.max_len == args.min_len:
        ...
        val_dl = DataLoader(part_val_gen, batch_size=args.batch_size, shuffle=False, collate_fn=collate_fn)
    ...
    if args.train:
        ...
        #model_name = f"traj_encode_missing_option_{args.model}_{args.option}_{args.min_len}_{args.max_len}_{args.target_len}_dropout_2_3_2_0_2_1_2_x_semb_8_gen.pth"
        #torch.save(model.state_dict(), model_name)
